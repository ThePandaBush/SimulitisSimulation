public class UI{
  ...
  */
  public void display(int citySize){
    ...
    text("Day: " + dayCount, 30, citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citySize
    text("Current Infections: " + infected, 400, citySize - 25);
    
    text("Recovered: " + recovered, 130, citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citySize
    text("Dead: " + dead, 250, citySize - 25);
  }
}
